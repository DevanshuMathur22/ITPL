    ...
    >
      ...
      >
        ...
        <div>
         ...
         <h2 className="text-sm text-white/90 text-xl uppercase tracking-wide mb-2">
           Take Part in the
          </h2>
          ...
          <p className="mt-4 text-white/90 text-lg">
           Find products and services built to help us all work together. Personalize every experience along the customer journey with an industry-renowned web and app development company.
